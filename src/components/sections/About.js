            ...
            <div className={innerClasses}>
                ...
                <div className={splitClasses}>
                    ...
                    <div className="split-item">
                        <div className="split-about-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                            ...
                            <Link to="#0" className="button button-primary button-wide-mobile button-sm btn-signup">Learn more</Link>
                        </div>
                        <div className={
                            classNames(
